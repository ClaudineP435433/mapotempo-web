...
class Visit < ApplicationRecord
  ...
  time_attr :open1, :close1, :open2, :close2, :duration
  ...
  def update_outdated
    if @tag_ids_changed || open1_changed? || close1_changed? || open2_changed? || close2_changed? || quantities_changed? || duration_changed?
      outdated
    end
  end
